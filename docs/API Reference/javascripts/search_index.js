var search_data = {
    "index": {
        "searchIndex": [
             ...
             "setvideosource",
             "the fpvwidget will always show the hd_gimbal video feed if true. by default, this flag is set  to true, which means the fpvwidget will set the live video channel to hd_gimbal automatically  when connecting the product. so far this flag only works for the product type m600, m600pro, a3, or n3.  @param videosource an enum value of `videosource`.",
             "getvideosource",
             "retrieves the type of the video feed selection.  @return an enum value of `videosource`.",
             "videosource",
             "options for the user to select the video feed to associate with the fpvwidget.",
             "auto",
